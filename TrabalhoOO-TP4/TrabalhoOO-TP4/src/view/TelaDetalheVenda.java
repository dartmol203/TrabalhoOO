...
/**
 * Mostra por meio de uma interface gráfica as opções disponíveis para customização e gerenciamento das vendas da loja de óculos, mas com maior especifidade.
...
public class TelaDetalheVenda implements ActionListener {
    ...
    /**Mostra por meio de uma interface  opções de cadastro e customização das vendas .Existem duas opções:
     * (1) Cadastro de uma nova venda
     * (2) Detalhe de venda
     ...
     * @param t instância de TelaVenda, responsável por acessar dados armazenados na mesma.
