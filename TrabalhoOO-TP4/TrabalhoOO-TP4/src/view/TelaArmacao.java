...
/**
 * Mostra por meio de uma interface gráfica as opções disponíveis para customização e gerenciamento das armações na loja de óculos registrada.
...
public class TelaArmacao implements ActionListener, ListSelectionListener {
	...
	/**Mostra na interface gráfica da opção selecionada  as armações cadastradas .Existe uma opção de escolha:
     * (1)Armações cadastradas
