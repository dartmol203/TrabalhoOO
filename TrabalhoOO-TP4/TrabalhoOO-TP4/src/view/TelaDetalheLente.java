...
/**
 * Mostra por meio de uma interface gráfica as opções disponíveis para customização e gerenciamento das lentes cadastradas .
...
public class TelaDetalheLente implements ActionListener {
    ...
    /**Mostra por meio de uma interface  opções de cadastro e customização das lentes .Existem duas opções:
     * (1) Cadastro de uma nova lente
     * (2) Detalhe de lente
     ...
     * @param t instância de TelaLente, responsável por acessar dados armazenados na mesma.
