...
/**
 * Mostra por meio de uma interface gráfica as opções disponíveis para customização e gerenciamento da loja de óculos registrada.
...
public class TelaDetalheLoja implements ActionListener {
    ...
    /**Mostra por meio de uma interface gráfica opções de cadastro e customização da loja. 
     * @param d instância de ControleDados, responsável por acessar dados armazenados na mesma.
     * @param l instância de TelaLoja, responsável por acessar dados armazenados na mesma.
