...
/**
 * Mostra por meio de uma interface gráfica as opções disponíveis para customização e gerenciamento  de diferentes componentes da loja de óculos.
...
public class TelaMenu implements ActionListener {
	...
	/**Garante que a seleção dos botões do menu estejam funcionando
	 * @param args array que recebe dados da linha de comando, o que evita a execução em um ambiente equivocado
	 */
