...
public class TelaDetalheArmacao implements ActionListener {
	...
	/**Mostra por meio de uma interface  opções de cadastro e customização das armações .Existem duas opções:
     * (1) Cadastro de uma nova armação
     * (2) Detalhe de armação
	 ...
	 * @param t instância de TelaArmação, responsável por acessar dados armazenados na mesma.
