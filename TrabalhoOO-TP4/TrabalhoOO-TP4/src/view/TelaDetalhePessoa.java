...
/**
 * Mostra por meio de uma interface gráfica as opções disponíveis para customização e gerenciamento dos clientes e funcionários relacionados a loja de óculos registrada.
...
public class TelaDetalhePessoa implements ActionListener {
	...
	/**Mostra por meio de uma interface  opções de cadastro e customização dos clientes e funcionários .Existem quatro opções:
     * (1) Cadastro de cliente
     * (2) cadastro de funcionário
     * (3) detalhe de cliente
     * (4) detalhe de funcionário
	 * @param op int que indica opção selecionada
	 * @param d instância de ControleDados, responsável por acessar dados armazenados na mesma.
	 * @param p instância de TelaPessoa, responsável por acessar dados armazenados na mesma.
	 * @param pos int responsável por guardar a posição na array a ser cadastrado do atributo a ser editado ou cadastrado
	 */
