...
/**
 * Mostra por meio de uma interface gráfica as opções disponíveis para customização e gerenciamento das vendas realizadas na loja de óculos registrada.
...
public class TelaVenda implements ListSelectionListener, ActionListener {
    ...
    /**Mostra na interface gráfica da opção selecionada  as vendas cadastradas de um produto.Existe uma opção de escolha:
     * (1)Vendas cadastradas
